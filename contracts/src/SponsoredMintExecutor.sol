...
contract SponsoredMintExecutor {
    ...
    bytes32 private constant _NAME_HASH = keccak256("Seamint Sponsored Mint");
    bytes32 private constant _VERSION_HASH = keccak256("2");
    bytes32 private constant _BATCH_GUARD_SLOT = keccak256("seamint.sponsored-mint.batch-guard.v1");
    bytes32 private constant _MINT_ACTIVE_SLOT = keccak256("seamint.sponsored-mint.active.v1");
    bytes32 private constant _MINT_NFT_SLOT = keccak256("seamint.sponsored-mint.nft.v1");
    bytes32 private constant _MINT_RECIPIENT_SLOT = keccak256("seamint.sponsored-mint.recipient.v1");
    bytes32 private constant _MINT_EXPECTED_SLOT = keccak256("seamint.sponsored-mint.expected.v1");
    bytes32 private constant _MINT_FORWARDED_SLOT = keccak256("seamint.sponsored-mint.forwarded.v1");
    bytes32 private constant _SEEN_WALLET_NAMESPACE = keccak256("seamint.sponsored-mint.seen-wallet.v1");
